...
const NAV_ITEMS = [
  ...
  { to: 'workflows', label: 'Workflows', icon: 'fas fa-project-diagram' },
  { to: 'entities',  label: 'Entities',  icon: 'fas fa-globe' },
  { to: 'modules',   label: 'Modules',   icon: 'fas fa-cubes' },
  { to: 'scripts',   label: 'Scripts',   icon: 'fas fa-terminal' },
  { to: 'overrides', label: 'Overrides', icon: 'fas fa-user-shield' },
